...
do
    ...
    hbb:AddSlider('hitbox_head_size_y', { Text = 'size y', Default = 10, Min = 1, Max = 1000, Rounding = 1, Compact = false }):OnChanged(function(State)
...
do
    ...
    mvb:AddSlider('speedhack_speed',{ Text = 'speed', Default = 55, Min = 1, Max = 150, Rounding = 0, Suffix = "sps", Compact = false }):OnChanged(function(State)
        speed = State
    end)
    ...
    mvb:AddSlider('downcliff_fall',{ Text = 'fall speed', Default = 55, Min = 1, Max = 200, Rounding = 0, Suffix = "sps", Compact = false }):OnChanged(function(State)
...
do
    ...
    mvb:AddSlider('carfly_speed',{ Text = 'speed', Default = 150, Min = 1, Max = 300, Rounding = 0, Suffix = "sps", Compact = false }):OnChanged(function(State)
        speed = State
    end)
    mvb:AddSlider('carfly_upspeed',{ Text = 'up speed', Default = 15, Min = 1, Max = 100, Rounding = 0, Suffix = "sps", Compact = false }):OnChanged(function(State)
        upspeed = State
    end)
    mvb:AddSlider('carfly_accel',{ Text = 'acceleration', Default = 100, Min = 1, Max = 300, Rounding = 0, Suffix = "sps", Compact = false }):OnChanged(function(State)
        accel = State
    end)
    mvb:AddLabel("hold V to go up")
    mvb:AddLabel("hold B to go down")
    local car, dist = nil, 100
